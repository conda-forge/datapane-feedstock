...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/datapane-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10207&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/datapane-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `datapane` can be installed with:

```
conda install datapane
```

It is possible to list all of the versions of `datapane` available on your platform with:
